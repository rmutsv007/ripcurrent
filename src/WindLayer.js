...
function WindLayer({ windData, pane = 'windPane' }) {
  ...
  useEffect(() => {
    ...
    const velocityLayer = L.velocityLayer({
      ...
      particleMultiplier: 0.0025, // ปรับลดปริมาณเส้นลม (ค่าน้อย = ลมน้อยลง ลองเปลี่ยนเป็น 0.002 หรือ 0.0005 ได้ครับ)
      lineWidth: 1, // ปรับความหนาของเส้นลมให้บางลงเพื่อให้ดูสบายตาขึ้น
      // ------------------------------------
